...
func main() {
	...
	mux.HandleFunc("/email", wh.Email)
	mux.HandleFunc("/offramprecords", wh.OffRampRecord)
	mux.HandleFunc("/onramprecords", wh.OnRampRecord)
	mux.HandleFunc("/offrampintents", wh.AvailableOffRampsIntents)
